...
namespace Backend.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        public GenerosController(MusicCoreContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("deleteds/")]
        public async Task<ActionResult<IEnumerable<Genero>>> GetGenerosDeleteds()
        {
            return await _context.Generos.IgnoreQueryFilters().Where(c => c.IsDeleted.Equals(true)).ToListAsync();
        }
        ...
        public async Task<IActionResult> RestoreGenero(int id)
        {
            ...
            genero.IsDeleted = false; //soft restore
            _context.Generos.Update(genero);
            await _context.SaveChangesAsync();
