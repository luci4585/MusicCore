...
namespace Backend.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        public ClientesController(MusicCoreContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Clientes.IgnoreQueryFilters().Where(c => c.IsDeleted.Equals(true)).ToListAsync();
        }
        ...
        public async Task<IActionResult> RestoreCliente(int id)
        {
            ...
            cliente.IsDeleted = false; //soft restore
            _context.Clientes.Update(cliente);
            await _context.SaveChangesAsync();
